...
- Edited every tracked Markdown file using the Humanizer 2.1.0 checklist. The pass
  removed decorative emoji headings, canned phrasing, mechanical emphasis, and stiff
  sentence patterns while preserving commands, measurements, and safety limits.
- Rewrote the explanatory Python comments in the Vast API, runner, and web modules.
  Benchmark behavior did not change.
- Updated package and release metadata for the public repository launch.
...
- Single-offer and parallel Vast runners with projected-cost enforcement and exact
  instance cleanup.
...
- A light dashboard theme with self-hosted Geist Sans and Geist Mono.
...
- MIT licensing and protected-branch release controls for public collaboration.
