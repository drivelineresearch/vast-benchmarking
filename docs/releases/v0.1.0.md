...
The first release packages the bounded Python benchmark, Vast.ai controller, SQLite
result store, and Flask dashboard used to compare container-visible hardware capacity.
...
- A light dashboard with self-hosted Geist Sans and Geist Mono.
- Wheel and source distributions containing the CLI, dashboard, generated artwork, and
  favicon family.
- Separate guides for the measured demo, methodology, Vast.ai execution, and
  self-hosting. CI checks their local links.
...
See the [versioned demo snapshot](https://github.com/drivelineresearch/vast-benchmarking/blob/v0.1.0/docs/benchmarks/2026-08-22-demo.md)
